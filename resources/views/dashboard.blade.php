                ...
                <table class="table table-hover table-vcenter">
                  ...
                  <tbody class="fs-sm">
                    ...
                    <tr>
                      ...
                      <td class="d-none d-sm-table-cell">
                        <div class="progress mb-1" style="height: 5px;" role="progressbar" aria-valuenow="24" aria-valuemin="0" aria-valuemax="100">
                    ...
                    <tr>
                      ...
                      <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">14 min ago</td>
                      <td class="d-none d-sm-table-cell text-end">
                        <strong>$2295,42</strong>
                      </td>
                    </tr>
                    <tr>
                      <td>
