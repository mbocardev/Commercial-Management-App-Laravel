<nav id="sidebar" aria-label="Main Navigation">
        <div class="content-header">
          ...
          <a class="fw-semibold text-dual" href="index.html">
            ...
            <span class="smini-hide fs-5 tracking-wider">CM App</span>
          </a>
          <!-- END Logo -->
        ...
        <div class="js-sidebar-scroll">
          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                    <a class="nav-main-link" href="admin/user/index">
              ...
              <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                  <i class="nav-main-link-icon fa fa-image-portrait"></i>
                  <span class="nav-main-link-name">Customer</span>
                </a>
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="be_blocks_styles.html">
                      <span class="nav-main-link-name">Add Custommer</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="be_blocks_options.html">
                      <span class="nav-main-link-name">View Customers</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="be_blocks_styles.html">
                      <span class="nav-main-link-name">Add Order</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="be_blocks_options.html">
